...
void EverySecondCheck(void)
{
 ...
 if (msLeap%100==0){ SetStatusLED(0,0,12-lumi,lumi*WIFIConnected,0); }                         // Do not update the LED unnecesary often
...
//--------------------------------------------
void SetStatusLED(uint32_t WW, uint32_t CW, uint32_t Re, uint32_t Gr, uint32_t Bl)
{
 analogWrite(REDPIN, Re);
 analogWrite(GREENPIN, Gr);
...
//--------------------------------------------
//  BUTTONS   Change the time with  Buttons
//--------------------------------------------
...
// UG_FillFrame(0, 0, sizeX - 1, sizeY - 1, C_ORANGE);
//// UG_FontSelect(&FONT_5X8);                                                     // &FONT_POCUTER_4X6 &FONT_8X8); // 5X8 looks best
// UG_SetForecolor(C_BLACK);
// UG_SetBackcolor(C_ORANGE);
////  UG_FillFrame(0, 0, sizeX - 1, sizeY - 1, C_DARK_BLUE);
// UG_FontSelect(&FONT_8X8);                                                   // Set back FONT_5X8
// UG_PutString(5,16,"Starting") ;
}
...
{ 
// UG_FillScreen(Mem.BackGround);  //C_BLACK );
// UG_FontSelect(&FONT_5X8);                                                     // Set back FONT_5X8
}
//--------------------------------------------
//  SCREEN 
...
//         {UG_PutChar ( Strippos[LEDnr].Character , 6*x, 7*y , Strippos[LEDnr].RGBColor , BackgroundColor ); LEDnr++;}
}
//                                                                                            //
//--------------------------------------------
//  SCREEN 
...
//         UG_PutChar(Strippos[LEDnr].Character, 6*x, 8*y, Strippos[LEDnr].RGBColor, Mem.BackGround);  //C_BLACK );
}
//--------------------------------------------
...
// ClearScreen(); 
 ...
 sprintf(sptext,"%02d:%02d:%02d",timeinfo.tm_hour,timeinfo.tm_min,timeinfo.tm_sec);
// UG_FontSelect(&FONT_8X8);                                                     // FONT_10X16
// UG_SetForecolor(C_DARK_ORANGE);
// UG_SetBackcolor(C_BLACK);
// UG_FillFrame(15, 22, 95, 32, Mem.BackGround);  //C_BLACK );
// UG_PutString(15,22,sptext);
 
 if (Date_Printed) return;
 
 sprintf(sptext,"%02d-%02d-%04d",timeinfo.tm_mday,timeinfo.tm_mon,timeinfo.tm_year+1900);
// UG_FontSelect(&FONT_5X8);                                                     // FONT_10X16
// UG_SetForecolor(C_YELLOW);
// UG_SetBackcolor(C_BLACK);
// UG_FillFrame(21, 56, 95, 64, Mem.BackGround);  //C_BLACK );
// UG_PutString(22, 55,sptext);
// UG_FontSelect(&FONT_5X8);                                                     // Set back FONT_5X8
 Date_Printed = true;
}
//--------------------------------------------
...
// UG_SetBackcolor(C_BLACK);
//// UG_PutString(1,1,"IP address:");
// UG_FillFrame(1, 1, 95, 6, C_BLACK);
// UG_PutString(1, 1, sptext);
