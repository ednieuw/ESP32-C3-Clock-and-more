...
void EverySecondCheck(void)
{
 ...
 if (msLeap%100==0){ SetStatusLED(-1,-1,12-lumi,lumi*WIFIConnected,-1); }                         // Do not update the LED unnecesary often
...
//------------------------------------------------------------------------------
//  LED Set brighness of backlight
//------------------------------------------------------------------------------  
...
void ShowChars(uint32_t BackgroundColor)
{
 ...
 for(int y=0;y<MATRIX_HEIGHT;y++)
    for(int x=0;x<MATRIX_WIDTH;x++,LEDnr++)
      tft.drawChar(20 * x, 10 + 27 * y, 
           Strippos[LEDnr].Character, 
           ConvertRGB32toRGB16(Strippos[LEDnr].RGBColor), 
           ConvertRGB32toRGB16(BackgroundColor), 2); 
}
//                                                                                            //
//--------------------------------------------
//  SCREEN 
